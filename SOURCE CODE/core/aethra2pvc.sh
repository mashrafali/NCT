...
echo -e '\E[30;32m'"\033[1m        First Data PVC Information:\033[0m"

read -p '                                   Customer DLCI         : ' XDLCI1                                     ##### DLCI IN

read -p '                                   Data VPI              : ' XDVPI1                                    ##### Data VPI IN

read -p '                                   Data VCI              : ' XDVCI1                                     ##### Data VCI IN
echo -e '\E[30;32m'"\033[1m        Second Data PVC Information:\033[0m"

read -p '                                   Customer DLCI         : ' XDLCI2                                     ##### DLCI IN

read -p '                                   Data VPI              : ' XDVPI2                                    ##### Data VPI IN

read -p '                                   Data VCI              : ' XDVCI2                                     ##### Data VCI IN
echo '  '
...
sleep 0.2
screen -X stuff $'set sdsl eoc on\r'
sleep 0.2
screen -X stuff $'set sdsl dyinggasp on\r'
sleep 0.2
screen -X stuff $'set sdsl annex a\r'
sleep 0.2
screen -X stuff $'set m-vcc on\r'
sleep 0.2
screen -X stuff $'set m-vcc loglevel 1\r'
sleep 0.2
...
sleep 0.2
screen -X stuff $'set m-vcc ip mtu 1500\r'
sleep 0.2
screen -X stuff $'set m-vcc ip loglevel 1\r'
sleep 0.2
screen -X stuff $'set m-vcc atm  traffic-type UBR 64\r'
sleep 0.2
screen -X stuff $'set m-vcc atm loglevel 1\r'
sleep 0.2
...
screen -X stuff $'\r'
sleep 0.2
screen -X stuff $'set m-vcc atm keep_alive OFF\r'
sleep 0.2
if   [ "$Dpointer" = "2" ]
   then ( screen -X stuff $'set ntp atm vcc-vcc-1 keep_alive off\r' )                                    #### IF ZYXEL DSLAM
fi
sleep 0.2
screen -X stuff $'set m-vcc atm polling_time 10\r'
sleep 0.2
screen -X stuff $'set m-vcc atm retry_time 1\r'
sleep 0.2
screen -X stuff $'set m-vcc atm up_retry_cnt 3\r'
sleep 0.2
screen -X stuff $'set m-vcc atm down_retry_cnt 5\r'
sleep 0.2
screen -X stuff $'set m-vcc service encapsulation routed\r'
sleep 0.2
screen -X stuff $'set m-vcc service llcsnap on\r'
sleep 0.2
...
screen -X stuff $XDVPI1                                                                          ### 1st DATA VPI
screen -X stuff $'\r'
sleep 0.2
screen -X stuff 'set ntp atm vcc-vcc-1 vci '
screen -X stuff $XDVCI1                                                                         ### 1st DATA VCI
screen -X stuff $'\r'
sleep 0.2
screen -X stuff $'top\r'
sleep 0.2
screen -X stuff $'ntp atm\r'
sleep 0.2
screen -X stuff $'add vcc vcc-2\r'
sleep 0.2
screen -X stuff $'top\r'
sleep 0.2
screen -X stuff 'set ntp atm vcc-vcc-2 vpi '
screen -X stuff $XDVPI2                                                                          ### 2nd DATA VPI
screen -X stuff $'\r'
sleep 0.2
screen -X stuff 'set ntp atm vcc-vcc-2 vci '
screen -X stuff $XDVCI2                                                                         ### 2nd DATA VCI
screen -X stuff $'\r'
sleep 0.2
...
screen -X stuff $XDLCI1                                                                         #### 1st DLCI
screen -X stuff $'\r'
sleep 0.2
screen -X stuff $'top\r'
sleep 0.2
screen -X stuff $'ntp\r'
sleep 0.2
screen -X stuff $'add frs-iwf 2\r'
sleep 0.2
screen -X stuff $'top\r'
sleep 0.2
screen -X stuff $'set ntp frs-iwf-2 vcc VCC-vcc-2\r'
sleep 0.2
screen -X stuff $'set ntp frs-iwf-2 fr-ifc FR-IFC-1\r'
sleep 0.2
screen -X stuff 'set ntp frs-iwf-2 dlci '
screen -X stuff $XDLCI2                                                                         #### 2nd DLCI
screen -X stuff $'\r'
sleep 0.2
screen -X stuff $'set snmp off\r'
sleep 0.2
screen -X stuff $'set snmp read_community_name public\r'
sleep 0.2
screen -X stuff $'set snmp write_community_name\r'
sleep 0.2
screen -X stuff $'set snmp manager 0.0.0.0\r'
sleep 0.2
screen -X stuff $'set snmp alternativemanager 0.0.0.0\r'
sleep 0.2
screen -X stuff $'set snmp authentication_trap on\r'
sleep 0.2
screen -X stuff $'set snmp syscontact\r'
sleep 0.2
screen -X stuff $'set snmp sysname atos\r'
sleep 0.2
screen -X stuff $'set snmp syslocation\r'
sleep 0.2
screen -X stuff $'set snmp enable_write_message off\r'
sleep 0.2
screen -X stuff $'set snmp loglevel 1\r'
sleep 0.2
