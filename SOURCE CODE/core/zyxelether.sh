...
clear
          ...
          echo -n '                                 2) 4-Wire DSL Mode'
          echo -e '\E[20;31m'"\033[1m (Zyxel P-793 Only!)\033[0m"
          echo ' '
...
echo -n '                    	                                ';echo -en '\E[20;34m'"\033[1mWelcome to the Zyxel P700 Configuration Menu!\033[0m"
echo ' '
echo -e '\E[30;32m'"\033[1m---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------\033[0m"
...
sleep 0.2
screen -X stuff $'wan node encap enet\r'                           ######## MODE
sleep 0.2
screen -X stuff $'wan node mux llc\r' 
sleep 0.2
